      ...
      <main className="flex-1 ml-64 flex flex-col min-h-screen">
        ...
        <section className="p-12 space-y-12">
          ...
          <div className="flex justify-between items-end">
            ...
            <button className="flex items-center gap-3 bg-primary text-on-primary px-8 py-4 rounded-xl font-medium shadow-md hover:shadow-xl transition-all active:scale-95">
              <Plus />
