...
const CategoryManagement = () => {
  ...
  return (
    ...
    <div className="relative min-h-screen bg-surface font-body text-on-surface antialiased">
      {/* Background */}
      <div className="absolute inset-0 z-0 opacity-40 grayscale pointer-events-none">
        <img
          src="https://lh3.googleusercontent.com/aida-public/AB6AXuA_6ZT3yfG1VHxbEDAcd8kR1GEd_PFwouB2t8q2umJ-uV4eQ_Y-me8osbM93-x_iTDDKcOr15_2tBxdmRoVQATpRuTvHSrnmF6qs79GImKdiVWwEhx4r9O6jj_Rcrm3iHmsz547VsJ52YaXGQy1IpWDXVezUdlONCAgjDQFr4DBoUe-WxmiNSrB2uJMV2vpjFE8Dc0sd_CaX-wCLq9FSHLInLVedfENIqH22EREqg8iBeZ_lqdsrBdDu8tmGvw2JQ-PpnTT9iodAAE"
      ...
      {/* Overlay */}
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-surface/70 px-4 py-6 backdrop-blur-xl">
        {/* Modal */}
