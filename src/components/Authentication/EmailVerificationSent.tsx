              ...
              <div className="flex flex-col items-center justify-center gap-4 pt-4">
                ...
                <div className="flex flex-col items-center md:items-start gap-1">
                  ...
                  <button
                    ...
                    className="text-primabg-primary font-semibold text-sm hover:text-terbg-tertiary transition-colors duration-200 underline decoration-primabg-primary/20 underline-offset-4"
                  >
